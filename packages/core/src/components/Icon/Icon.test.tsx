...
describe("Component - Icon", () => {
  ...
  const renderComponent = () => render(<Layout theme={createTheme()} cdnBasepath={''}><Icon {...props} /></Layout>);
  const updateComponent = (renderer, props) => renderer(<Layout theme={createTheme()} cdnBasepath={''}><Icon {...props} /></Layout>);
