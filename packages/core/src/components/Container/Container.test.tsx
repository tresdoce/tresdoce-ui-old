...
describe("Component - Container", () => {
  ...
  const renderComponent = () => render(<Layout theme={theme} cdnBasepath={''}><Container {...props} /></Layout>);
  const updateComponent = (renderer, props) => renderer(<Layout theme={theme} cdnBasepath={''}><Container {...props} /></Layout>);
